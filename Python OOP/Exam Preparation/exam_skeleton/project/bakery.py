...
class Bakery:
    ...
    def order_food(self, table_number: int, *food_names: []):
        table = self.find_table_number(table_number)
        if table is None:
        ...
        return ordered_foods + skipped_foods.strip()
    ...
    def order_drink(self, table_number: int, *drinks_names: []):
        ...
        return ordered_drinks + skipped_drinks.strip()
    ...
    def find_table_number(self, table_number):
        for table in self.tables_repository:
